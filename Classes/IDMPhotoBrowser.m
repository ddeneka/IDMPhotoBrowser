...
- (void)panGestureRecognized:(id)sender {
    ...
    float newAlpha = MAX(0.0, MIN(0.9, 0.9 - fabsf(newY)/viewHeight)); //abs(newY)/viewHeight * 1.8;
    ...
    if ([(UIPanGestureRecognizer*)sender state] == UIGestureRecognizerStateEnded) {
        ...
        else // Continue Showing View
        {
            ...
            self.view.backgroundColor = [UIColor colorWithWhite:(_useWhiteBackgroundColor ? 1 : 0) alpha:0.9];
